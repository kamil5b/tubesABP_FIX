    ...
    <body class="text-center" style="background-color:rgb(210, 210, 210);">
        <div class="container" style="margin: auto;">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" id="reg">{{ __('Input Destination') }}</div>
                        <br>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row mb-3">
                                    <label for="destination"
                                        class="col-md-4 col-form-label text-md-end">{{ __('Destination') }}</label>

                                    <div class="col-md-6">
                                        <input id="formbox" id="name" type="text"
                                            class="form-control @error('name') is-invalid @enderror" name="destination"
                                            value="{{ old('destination') }}" required autocomplete="destination"
                                            autofocus>
